...
#ifndef soapwstService_H
#define soapwstService_H
#include "soapH.h"

    class SOAP_CMAC wstService {
      public:
        ...
        virtual void wstService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual wstService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        wstService& operator=(const wstService&);
        ...
        //
        /// Web service operation 'RequestSecurityToken' implementation, should return SOAP_OK or error code
        virtual int RequestSecurityToken(struct wst__RequestSecurityTokenType *wst__RequestSecurityToken, struct wst__RequestSecurityTokenResponseType *wst__RequestSecurityTokenResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'RequestSecurityTokenResponse' implementation, should return SOAP_OK or error code
        virtual int RequestSecurityTokenResponse(struct wst__RequestSecurityTokenResponseType *wst__RequestSecurityTokenResponse, struct wst__RequestSecurityTokenResponseCollectionType *wst__RequestSecurityTokenResponseCollection) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'RequestSecurityTokenCollection' implementation, should return SOAP_OK or error code
        virtual int RequestSecurityTokenCollection(struct wst__RequestSecurityTokenCollectionType *wst__RequestSecurityTokenCollection, struct wst__RequestSecurityTokenResponseCollectionType *wst__RequestSecurityTokenResponseCollection) SOAP_PURE_VIRTUAL;
    };
#endif
